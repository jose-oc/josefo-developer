...
!(function(a, b) {
  ...
  (r.fn = r.prototype = {
          ...
          (c = g[b]), (d = a[b]), g !== d &&
            (j && d && (r.isPlainObject(d) || (e = Array.isArray(d)))
              ? (e
                  ...
                  : (f = c && r.isPlainObject(c) ? c : {}), (g[b] = r.extend(
                  j,
                  f,
                  d
                )))
    ...
    isPlainObject: function(a) {
      ...
      return (
        ...
        (!(b = e(a)) ||
          ((c = l.call(b, "constructor") && b.constructor), "function" ==
            typeof c && m.call(c) === n))
      );
    },
    ...
    proxy: function(a, b) {
      var c, d, e;
      if (
        ("string" == typeof b && ((c = a[b]), (b = a), (a = c)), r.isFunction(
          a
        ))
      )
  ...
  var x = (function(a) {
    ...
    try {
      G.apply((D = H.call(v.childNodes)), v.childNodes), D[v.childNodes.length]
        .nodeType;
    } catch (fa) {
      G = {
        apply: D.length
    ...
    function ga(a, b, d, e) {
      ...
      if (
        ...
        return d;
      if (
        !e && ((b ? b.ownerDocument || b : v) !== n && m(b), (b = b || n), p)
      ) {
        if (11 !== w && (l = Z.exec(a)))
          if ((f = l[1])) {
            if (9 === w) {
            ...
            if (
              (f = l[3]) && c.getElementsByClassName && b.getElementsByClassName
            )
        ...
        if (c.qsa && !A[a + " "] && (!q || !q.test(a))) {
          if (1 !== w) (s = b), (r = a);
            ...
            (k = b.getAttribute("id"))
              ? (k = k.replace(ba, ca))
              : b.setAttribute("id", (k = u)), (o = g(a)), (h = o.length);
            while (h--)
              o[h] = "#" + k + " " + sa(o[h]);
    ...
    (c = ga.support = {}), (f = ga.isXML = function(a) {
      ...
      return g !== n && 9 === g.nodeType && g.documentElement
        ? ((n = g), (o = n.documentElement), (p = !f(n)), v !== n &&
            ...
            (e.addEventListener
              ...
              : e.attachEvent &&
                  e.attachEvent("onunload", da)), (c.attributes = ja(function(
            a
          ) {
            ...
            }), (r = []), (q = []), (c.qsa = Y.test(n.querySelectorAll)) &&
            (ja(function(a) {
      ...
      var b, d = [], e = 0, f = 0;
      if (
        ((l = !c.detectDuplicates), (k = !c.sortStable && a.slice(0)), a.sort(
          B
        ), l)
      ) {
        while ((b = a[f++]))
            ...
            : function(b, c, i) {
                ...
                if (q) {
                  ...
                  if (((o = [g ? q.firstChild : q.lastChild]), g && s)) {
                    (m = q), (l = m[u] || (m[u] = {})), (k =
                      l[m.uniqueID] || (l[m.uniqueID] = {})), (j = k[a] || [
                    ]), (n = j[0] === w && j[1]), (t = n && j[2]), (m =
                      n && q.childNodes[n]);
    ...
    (ra.prototype = d.filters =
      d.pseudos), (d.setFilters = new ra()), (g = ga.tokenize = function(a, b) {
  ...
  r.each(
    {
      ...
      contents: function(a) {
        return B(a, "iframe")
          ? a.contentDocument
          : (B(a, "template") && (a = a.content || a), r.merge(
              [],
              a.childNodes
            ));
      }
    ...
    function(a, b) {
      r.fn[a] = function(c, d) {
        ...
        return "Until" !== a.slice(-5) && (d = c), d &&
          ...
          (J[a] || r.uniqueSort(e), I.test(a) && e.reverse()), this.pushStack(
          e
        );
      };
    }
  ...
  r.Callbacks = function(a) {
    ...
    var b,
      ...
      j = {
        add: function() {
          return f &&
            (c && !b && ((h = f.length - 1), g.push(c)), (function d(b) {
        ...
        fireWith: function(a, c) {
          return e ||
            ((c = c || []), (c = [a, c.slice ? c.slice() : c]), g.push(c), b ||
              i()), this;
        },
        fire: function() {
  ...
  r.extend({
          ...
          then: function(b, d, e) {
                    ...
                    : function() {
                        try {
                          ...
                          r.Deferred.exceptionHook &&
                            r.Deferred.exceptionHook(a, k.stackTrace), b + 1 >=
                            f &&
                            (d !== O && ((h = void 0), (i = [a])), c.rejectWith(
                              h,
                              i
                            ));
                        }
            ...
            return r
              .Deferred(function(a) {
                ...
                ), c[1][3].add(g(0, a, r.isFunction(b) ? b : N)), c[2][3].add(g(0, a, r.isFunction(d) ? d : O));
              })
              .promise();
          },
          promise: function(a) {
    ...
    when: function(a) {
      ...
      if (
        b <= 1 &&
        (P(a, g.done(h(c)).resolve, g.reject, !b), "pending" === g.state() ||
  ...
  "complete" === d.readyState ||
    ...
    : (d.addEventListener("DOMContentLoaded", S), a.addEventListener(
        "load",
        S
      ));
  ...
  function _(a, b, c) {
    ...
    if (void 0 === c && 1 === a.nodeType)
      if (
        ((d = "data-" + b.replace(Z, "-$&").toLowerCase()), (c = a.getAttribute(
          d
        )), "string" == typeof c)
      ) {
        try {
  ...
  r.extend({
    ...
    queue: function(a, b, c) {
      var d;
      if (a)
        return (b = (b || "fx") + "queue"), (d = W.get(a, b)), c &&
          (!d || Array.isArray(c)
  ...
  function fa(a, b, c, d) {
    ...
    return c &&
      ((k = +k || +i || 0), (e = c[1] ? k + (c[1] + 1) * c[2] : +c[2]), d &&
        ((d.unit = j), (d.start = k), (d.end = e))), e;
  }
  var ga = {};
  function ha(a) {
    ...
    return e
      ...
      : ((b = c.body.appendChild(c.createElement(d))), (e = r.css(
          b,
          "display"
        )), b.parentNode.removeChild(b), "none" === e && (e = "block"), (ga[
          d
        ] = e), e);
  }
  function ia(a, b) {
  ...
  (ma.optgroup =
    ma.option), (ma.tbody = ma.tfoot = ma.colgroup = ma.caption = ma.thead), (ma.th = ma.td);
  function na(a, b) {
    var c;
  ...
  function qa(a, b, c, d, e) {
    for (
      ...
      n++
        ...
        if ("object" === r.type(f)) r.merge(m, f.nodeType ? [f] : f);
          ...
          (g = g || l.appendChild(b.createElement("div"))), (h = (ka.exec(
            f
          ) || ["", ""])[1]
            .toLowerCase()), (i = ma[h] || ma._default), (g.innerHTML =
    ...
    while ((f = m[n++])) if (d && r.inArray(f, d) > -1) e && e.push(f);
        ...
        ((j = r.contains(f.ownerDocument, f)), (g = na(
          l.appendChild(f),
          "script"
        )), j && oa(g), c)
      ) {
  ...
  (r.event = {
    ...
    add: function(a, b, c, d, e) {
      ...
      if (q) {
        c.handler && ((f = c), (c = f.handler), (e = f.selector)), e &&
          r.find.matchesSelector(ra, e), c.guid || (c.guid = r.guid++), (i =
          q.events) || (i = q.events = {}), (g = q.handle) ||
        ...
        while (j--)
          (h = ua.exec(b[j]) || []), (n = p = h[1]), (o = (h[2] || "")
            .split(".")
            .sort()), n &&
            ((l = r.event.special[n] || {}), (n =
              (e ? l.delegateType : l.bindType) || n), (l = r.event.special[
              n
            ] || {}), (k = r.extend(
              {
                type: n,
              ...
              ((m = i[n] = []), (m.delegateCount = 0), (l.setup &&
                ...
                (a.addEventListener && a.addEventListener(n, g))), l.add &&
      ...
      if (q && (i = q.events)) {
        ...
        while (j--)
          if (
            ...
            (l = r.event.special[n] || {}), (n =
              (d ? l.delegateType : l.bindType) || n), (m = i[n] || []), (h =
              h[2] &&
              new RegExp(
                "(^|\\.)" + o.join("\\.(?:.*\\.|)") + "(\\.|$)"
              )), (g = f = m.length);
        ...
        while ((f = h[c++]) && !b.isPropagationStopped()) {
          ...
          while ((g = f.handlers[d++]) && !b.isImmediatePropagationStopped())
            (b.rnamespace && !b.rnamespace.test(g.namespace)) ||
              ((b.handleObj = g), (b.data = g.data), (e = ((r.event.special[
                g.origType
              ] || {}).handle || g.handler)
    ...
    return this instanceof r.Event
      ? (a && a.type
          ? ((this.originalEvent = a), (this.type =
              ...
              a.currentTarget), (this.relatedTarget = a.relatedTarget))
    ...
    preventDefault: function() {
      ...
      (this.isDefaultPrevented = va), a &&
        !this.isSimulated &&
        a.preventDefault();
    },
    stopPropagation: function() {
      var a = this.originalEvent;
      (this.isPropagationStopped = va), a &&
        !this.isSimulated &&
        a.stopPropagation();
    },
    stopImmediatePropagation: function() {
      var a = this.originalEvent;
      (this.isImmediatePropagationStopped = va), a &&
        !this.isSimulated &&
    ...
    off: function(a, b, c) {
      ...
      return (b !== !1 && "function" != typeof b) ||
        ((c = b), (b = void 0)), c === !1 && (c = wa), this.each(function() {
  ...
  function Ha(a, b) {
    ...
    if (1 === b.nodeType) {
      if (
        W.hasData(a) && ((f = W.access(a)), (g = W.set(b, f)), (j = f.events))
      ) {
  ...
  function Ja(a, b, c, d) {
    ...
    if (
      m &&
      ((e = qa(b, a[0].ownerDocument, !1, a, d)), (f = e.firstChild), 1 ===
        e.childNodes.length && (e = f), f || d)
    ) {
      for ((h = r.map(na(e, "script"), Fa)), (i = h.length); l < m; l++)
        (j = e), l !== n &&
          ((j = r.clone(j, !0, !0)), i && r.merge(h, na(j, "script"))), c.call(
          a[l],
          j,
          l
        );
  ...
  r.extend({
    ...
    clone: function(a, b, c) {
      ...
      return (g = na(h, "script")), g.length > 0 &&
        oa(g, !i && na(a, "script")), h;
    },
    ...
    function(a, b) {
      r.fn[a] = function(a) {
        for (var c, d = [], e = r(a), f = e.length - 1, g = 0; g <= f; g++)
          (c = g === f ? this : this.clone(!0)), r(e[g])[b](c), h.apply(
            d,
            c.get()
          );
    ...
    function b() {
      if (i) {
        ...
        (c = "1%" !== b.top), (g = "2px" === b.marginLeft), (e =
          ...
          "4px" === b.marginRight), ra.removeChild(h), (i = null);
      }
    }
  ...
  function Oa(a, b, c) {
    ...
    return (c =
      ...
      Na(
        a
      )), c && ((g = c.getPropertyValue(b) || c[b]), "" !== g || r.contains(a.ownerDocument, a) || (g = r.style(a, b)), !o.pixelMarginRight() && Ma.test(g) && La.test(b) && ((d = h.width), (e = h.minWidth), (f = h.maxWidth), (h.minWidth = h.maxWidth = h.width = g), (g = c.width), (h.width = d), (h.minWidth = e), (h.maxWidth = f))), void 0 !== g ? g + "" : g;
  }
  function Pa(a, b) {
    return {
      get: function() {
  ...
  function $a(a, b, c) {
    ...
    return Ma.test(f)
      ? f
      : ((d = g && (o.boxSizingReliable() || f === a.style[b])), "auto" === f &&
          (f = a["offset" + b[0].toUpperCase() + b.slice(1)]), (f =
          parseFloat(f) || 0), f +
          Za(a, b, c || (g ? "border" : "content"), d, e) +
          "px");
  }
  r.extend({
    cssHooks: {
    ...
    style: function(a, b, c, d) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        ...
        return i || (b = Xa(h)), (g =
          ...
          ? g && "get" in g && void 0 !== (e = g.get(a, !1, d)) ? e : j[b]
          : ((f = typeof c), "string" === f &&
              (e = ba.exec(c)) &&
              e[1] &&
              ((c = fa(a, b, e)), (f = "number")), null != c &&
              c === c &&
              ("number" === f &&
                (c +=
                  (e && e[3]) ||
                  (r.cssNumber[h] ? "" : "px")), o.clearCloneStyle ||
                "" !== c ||
    ...
    css: function(a, b, c, d) {
      ...
      return i || (b = Xa(h)), (g = r.cssHooks[b] || r.cssHooks[h]), g &&
        "get" in g &&
        (e = g.get(a, !0, c)), void 0 === e && (e = Oa(a, b, d)), "normal" ===
        e &&
        b in Ta &&
        (e = Ta[b]), "" === c || c
    ...
    r.cssHooks[b] = {
      ...
      set: function(a, c, d) {
        ...
        return g &&
          (e = ba.exec(c)) &&
          "px" !== (e[3] || "px") &&
          ((a.style[b] = c), (c = r.css(a, b))), Ya(a, c, g);
      }
    };
  ...
  (r.Tween = _a), (_a.prototype = {
    ...
    run: function(a) {
      ...
      return this.options.duration
        ...
        ? c.set(this)
        : _a.propHooks._default.set(this), this;
    }
    ...
    if (((i = !r.isEmptyObject(b)), i || !r.isEmptyObject(n))) {
      l &&
        ...
        ((c.overflow = [o.overflow, o.overflowX, o.overflowY]), (j =
          q && q.display), null == j && (j = W.get(a, "display")), (k = r.css(
          a,
          "display"
        )), "none" === k &&
          (j
          ...
          (i ||
            (m.done(function() {
              ...
              ((k = o.display), (j = "none" === k ? "" : k))), (o.display =
      ...
      for (d in n)
        i ||
          (q
            ...
            : (q = W.access(a, "fxshow", { display: j })), f &&
            (q.hidden = !p), p && ia([a], !0), m.done(function() {
            p || ia([a]), W.remove(a, "fxshow");
            for (d in n) r.style(a, d, n[d]);
          })), (i = hb(p ? q[d] : 0, d, m)), d in q ||
  ...
  function jb(a, b) {
    var c, d, e, f, g;
    for (c in a) if (
        ((d = r.camelCase(c)), (e = b[d]), (f = a[c]), Array.isArray(f) &&
          ((e = f[1]), (f = a[c] = f[0])), c !== d &&
  ...
  function kb(a, b, c) {
    ...
    return r.map(
      ...
      hb,
      j
    ), r.isFunction(j.opts.start) && j.opts.start.call(a, j), j.progress(j.opts.progress).done(j.opts.done, j.opts.complete).fail(j.opts.fail).always(j.opts.always), r.fx.timer(r.extend(i, { elem: a, anim: j, queue: j.opts.queue })), j;
  }
  (r.Animation = r.extend(kb, {
    ...
    tweener: function(a, b) {
      ...
      for (var c, d = 0, e = a.length; d < e; d++)
        (c = a[d]), (kb.tweeners[c] = kb.tweeners[c] || []), kb.tweeners[
          c
        ].unshift(b);
    },
    prefilters: [ib],
    ...
    return r.fx.off
      ...
      : "number" != typeof d.duration &&
          (d.duration in r.fx.speeds
            ...
            : (d.duration = r.fx.speeds._default)), (null != d.queue &&
      d.queue !== !0) ||
      (d.queue = "fx"), (d.old = d.complete), (d.complete = function() {
      r.isFunction(d.old) && d.old.call(this), d.queue &&
        r.dequeue(this, d.queue);
    }), d;
  }), r.fn.extend({
  ...
  r.fn.extend({
        ...
        return "undefined" == typeof a.getAttribute
          ...
          : ((1 === f && r.isXMLDoc(a)) ||
              (e =
                ...
                (r.expr.match.bool.test(b) ? lb : void 0)), void 0 !== c
              ? null === c
    ...
    mb[b] = function(a, b, d) {
      ...
      return d ||
        ((f = mb[g]), (mb[g] = e), (e = null != c(a, b, d) ? g : null), (mb[
          g
        ] = f)), e;
    };
  });
    ...
    prop: function(a, b, c) {
      ...
      if (3 !== f && 8 !== f && 2 !== f)
        return (1 === f && r.isXMLDoc(a)) ||
          ((b = r.propFix[b] || b), (e = r.propHooks[b])), void 0 !== c
    ...
    propHooks: {
      tabIndex: {
        get: function(a) {
          ...
          return b
            ? parseInt(b, 10)
            : nb.test(a.nodeName) || (ob.test(a.nodeName) && a.href) ? 0 : -1;
        }
      }
    },
      ...
      var b, c, d, e = this[0];
      {
        if (arguments.length)
          return (d = r.isFunction(a)), this.each(function(c) {
            var e;
            1 === this.nodeType &&
              ((e = d ? a.call(this, c, r(this).val()) : a), null == e
                ? (e = "")
                : "number" == typeof e
                    ? (e += "")
                    : Array.isArray(e) &&
        ...
        if (e)
          return (b =
            r.valHooks[e.type] || r.valHooks[e.nodeName.toLowerCase()]), b &&
            "get" in b &&
    ...
    valHooks: {
      ...
      select: {
        ...
        set: function(a, b) {
          ...
          while (g--)
            (d = e[g]), (d.selected =
              r.inArray(r.valHooks.option.get(d), f) > -1) && (c = !0);
      ...
      if (
        ((h = i = e = e || d), 3 !== e.nodeType &&
          ...
          (p.indexOf(".") > -1 &&
            ...
            (b.target = e), (c = null == c ? [b] : r.makeArray(c, [b])), (n = r
            .event.special[p] || {}), f ||
            !n.trigger ||
        ...
        while ((h = o[g++]) && !b.isPropagationStopped())
          (b.type = g > 1 ? j : n.bindType || p), (m =
            (W.get(h, "events") || {})[b.type] && W.get(h, "handle")), m &&
            m.apply(h, c), (m = k && h[k]), m &&
            m.apply &&
            U(h) &&
        ...
        return (b.type = p), f ||
          ...
          (k &&
            r.isFunction(e[p]) &&
            !r.isWindow(e) &&
            ((i = e[k]), i && (e[k] = null), (r.event.triggered = p), e[
              p
  ...
  r.extend({
    ...
    ajax: function(b, c) {
      ...
      var e,
        ...
        y = {
          ...
          setRequestHeader: function(a, b) {
            return null == k &&
              ((a = w[a.toLowerCase()] = w[a.toLowerCase()] || a), (v[
                a
              ] = b)), this;
          },
      ...
      if (
        (s.promise(y), (o.url = ((b || o.url || tb.href) + "").replace(
          Hb,
          tb.protocol + "//"
        )), (o.type =
          c.method ||
      ...
      if (
        (o.data &&
          ...
          (o.data = r.param(o.data, o.traditional)), Nb(Ib, o, c, y), k)
      )
        return y;
      (l = r.event && o.global), l &&
        ...
        r.event.trigger(
          "ajaxStart"
        ), (o.type = o.type.toUpperCase()), (o.hasContent = !Gb.test(
        o.type
      )), (f = o.url.replace(Cb, "")), o.hasContent
        ? o.data &&
            o.processData &&
            0 ===
              (o.contentType || "")
        ...
        : ((n = o.url.slice(f.length)), o.data &&
            ((f +=
              (vb.test(f) ? "&" : "?") + o.data), delete o.data), o.cache ===
            !1 &&
            ((f = f.replace(Db, "$1")), (n =
              (vb.test(f) ? "&" : "?") + "_=" + ub++ + n)), (o.url =
            f + n)), o.ifModified &&
        (r.lastModified[f] &&
          y.setRequestHeader("If-Modified-Since", r.lastModified[f]), r.etag[
          f
        ] && y.setRequestHeader("If-None-Match", r.etag[f])), ((o.data &&
        o.hasContent &&
        o.contentType !== !1) ||
        c.contentType) &&
        y.setRequestHeader("Content-Type", o.contentType), y.setRequestHeader(
        "Accept",
      ...
      function A(b, c, d, h) {
        ...
        k ||
          ((k = !0), i && a.clearTimeout(i), (e = void 0), (g =
            ...
            (b >= 200 && b < 300) || 304 === b), d &&
            (v = Pb(o, y, d)), (v = Qb(o, v, y, j)), j
            ? (o.ifModified &&
                ((w = y.getResponseHeader("Last-Modified")), w &&
                  (r.lastModified[f] = w), (w = y.getResponseHeader(
                  "etag"
                )), w && (r.etag[f] = w)), 204 === b || "HEAD" === o.type
                ? (x = "nocontent")
                : 304 === b
                    ? (x = "notmodified")
            ...
            : ((n = x), (!b && x) ||
                ((x = "error"), b < 0 &&
                  (b = 0))), (y.status = b), (y.statusText = (c || x) + ""), j
            ? s.resolveWith(p, [m, x, y])
            : s.rejectWith(p, [y, x, n]), y.statusCode(u), (u = void 0), l &&
    ...
    r[b] = function(a, c, d, e) {
      return r.isFunction(c) && ((e = e || d), (d = c), (c = void 0)), r.ajax(
        r.extend(
    ...
    wrapAll: function(a) {
      ...
      return this[0] &&
        (r.isFunction(a) && (a = a.call(this[0])), (b = r(
          ...
          .eq(0)
          .clone(!0)), this[0].parentNode && b.insertBefore(this[0]), b
          .map(function() {
            var a = this;
  ...
  (o.cors =
    !!Sb &&
    "withCredentials" in Sb), (o.ajax = Sb = !!Sb), r.ajaxTransport(function(
    b
  ) {
    var c, d;
    if (o.cors || (Sb && !b.crossDomain))
      return {
        send: function(e, f) {
          ...
          }), (h.onload = c()), (d = h.onerror = c("error")), void 0 !==
            h.onabort
            ? (h.onabort = d)
  ...
  r.ajaxSetup({
    ...
    if (h || "jsonp" === b.dataTypes[0])
      return (e = b.jsonpCallback = r.isFunction(b.jsonpCallback)
        ...
        : b.jsonp !== !1 &&
            (b.url +=
              (vb.test(b.url) ? "&" : "?") + b.jsonp + "=" + e), (b.converters[
        "script json"
      ] = function() {
        ...
        void 0 === f
          ...
          : (a[
              e
            ] = f), b[e] && ((b.jsonpCallback = c.jsonpCallback), Tb.push(e)), g && r.isFunction(f) && f(g[0]), (g = f = void 0);
      }), "script";
    ...
    return b ||
      (o.createHTMLDocument
        ? ((b = d.implementation.createHTMLDocument("")), (e = b.createElement(
            "base"
          )), (e.href = d.location.href), b.head.appendChild(e))
        : (b = d)), (f = C.exec(a)), (g = !c && []), f
      ? [b.createElement(f[1])]
      : ((f = qa([a], b, g)), g && g.length && r(g).remove(), r.merge(
          [],
          f.childNodes
        ));
  }), (r.fn.load = function(a, b, c) {
    var d, e, f, g = this, h = a.indexOf(" ");
    return h > -1 && ((d = pb(a.slice(h))), (a = a.slice(0, h))), r.isFunction(
      b
    )
      ? ((c = b), (b = void 0))
    ...
    setOffset: function(a, b, c) {
      ...
      "static" === k &&
        ...
        ("absolute" === k || "fixed" === k) && (f + i).indexOf("auto") > -1), j
        ? ((d = l.position()), (g = d.top), (e = d.left))
        : ((g = parseFloat(f) || 0), (e = parseFloat(i) || 0)), r.isFunction(
        b
    ...
    offset: function(a) {
      ...
      if (f)
        return f.getClientRects().length
          ? ((d = f.getBoundingClientRect()), (b = f.ownerDocument), (c =
              b.documentElement), (e = b.defaultView), {
    ...
    position: function() {
      if (this[0]) {
        ...
        return "fixed" === r.css(c, "position")
          ...
          : ((a = this.offsetParent()), (b = this.offset()), B(a[0], "html") ||
              (d = a.offset()), (d = {
    ...
    r.fn[a] = function(d) {
      return T(
        ...
        function(a, d, e) {
          ...
          return r.isWindow(a)
            ? (f = a)
            : 9 === a.nodeType && (f = a.defaultView), void 0 === e
            ? f ? f[b] : a[d]
            : void (f
  ...
  }), (r.isArray = Array.isArray), (r.parseJSON = JSON.parse), (r.nodeName = B), "function" ==
    typeof define &&
    define.amd &&
