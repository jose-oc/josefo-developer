...
url: /blog/parametros-por-valor-o-por-referencia-en-java/
categories:
  - Coding
  - java
tags:
        ...
        <div>
          <div>
            <div>
              ...
              <div style="text-align: justify">
              </div> La respuesta es por valor, 
              
              <strong>siempre por valor</strong>, pero esta respuesta puede resultar algo engañosa. Veámosla algo más en detalle.
            </div>
            
            <h2>
              Datos primitivos
            </h2> Si pasamos datos de tipo 
            
            <strong>primitivos</strong> se pasan por valor, <strong>no puedes modificar un parámetro de tipo primitivo en un método.</strong> He aquí un ejemplo: 
...
<div>
  <div>
    ...
    }</pre> Tras ejecutar este ejemplo vemos que la propiedad ha sido modificada, el nombre que obtenemos es &#8220;Lola&#8221;.
                        </div>
